        ...
        <ul class="nav">
          <li class="nav-item">
            <div class="d-flex sidebar-profile">
              ...
              <div class="sidebar-profile-name">dashboard/images/favicon.png
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href='{{ asset('dashboard/pages/ui-features/buttons.html') }}'>Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href='{{ asset('dashboard/pages/ui-features/dropdowns.html') }}'>Dropdowns</a></li>
                <li class="nav-item"> <a class="nav-link" href='{{ asset('dashboard/pages/ui-features/typography.html') }}'>Typography</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item"> 
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href='{{ asset('dashboard/pages/charts/chartjs.html') }}'>ChartJs</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="/administrator/admin">Basic table</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
